...
JS;
	...
	protected function initSettings()
	{
		...
		if ($this->startAttribute && $this->endAttribute) {
			if(
				$this->isValidTimeStamp($this->model->{$this->startAttribute}) &&
				$this->isValidTimeStamp($this->model->{$this->endAttribute})
			){
				$this->value = str_replace($this->model->{$this->startAttribute}, date($this->pluginOptions['locale']['format'], $this->model->{$this->startAttribute}), $this->value);
				$this->value = str_replace($this->model->{$this->endAttribute}, date($this->pluginOptions['locale']['format'], $this->model->{$this->endAttribute}), $this->value);
			}
		}
